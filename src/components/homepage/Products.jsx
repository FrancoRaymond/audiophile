...
const Products = () => {
  ...
  return (
    <div className='px-2 sm:px-5 md:px-10 lg:px-24 flex flex-col gap-10'>
        <div 
        ...
        >
            ...
            <div className='max-w-80 flex flex-col gap-7 md:text-left'>
                ...
                <button className='text-white cursor-pointer bg-black py-2 px-7 w-fit mx-auto md:mx-0'>SEE PRODUCT</button>
            </div>      
        </div>
        <div className='flex flex-col py-22 gap-10 px-5 rounded-xl bg-center bg-cover md:px20' style={{ backgroundImage: `url(${size > 640 ? zx7D : zx7})` }}>
            ...
            <button className='text-black cursor-pointer border-2 border-black font-semibold py-2 px-7 w-fit'>SEE PRODUCT</button>
        </div>
        <div className='flex flex-col gap-5 sm:flex-row'>
            ...
            <div className='bg-gray-100 py-10 flex flex-col gap-10 rounded-xl px-5 sm:w-1/2'>
                ...
                <button className='text-black cursor-pointer border-2 w-fit border-black font-semibold py-2 px-7'>SEE PRODUCT</button>
            </div>
        </div>
    </div>
  )
